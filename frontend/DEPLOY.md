...
```bash
VITE_API_BASE_URL=http://193.106.150.7:8000/api/
```
...
Приложение использует внешний API по адресу `http://193.106.150.7:8000/api/`.
...
- Убедитесь, что API сервер доступен и работает по адресу `http://193.106.150.7:8000/api/`
