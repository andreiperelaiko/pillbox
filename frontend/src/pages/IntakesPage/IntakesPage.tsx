...
import { createIntake, confirmMedicationInIntake } from '../../store/slices/intakesSlice';
import { IntakeCard } from '../../components/IntakeCard/IntakeCard';
import { Button } from '../../components/Button/Button';
import { Input } from '../../components/Input/Input';
import { Select } from '../../components/Select/Select';
import type { MedicationDose, DosageUnit } from '../../types';
...
export const IntakesPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const medicationDoses: MedicationDose[] = formData.selectedMedications.map(m => ({
  ...
  const handleConfirm = (intakeId: string, medicationId: string) => {
    dispatch(confirmMedicationInIntake({ intakeId, medicationId }));
  };
